...
class voltageContinuousInput(tk.Frame):
    ...
    def __init__(self, master):
        ...
        self.master = master
        self.master.title("Visual Distance Measurement")
    ...
    def startTask(self):
        ...
        physicalChannel = self.HASELSettingsFrame.physicalChannelEntry.get()
        maxVoltage = int(self.HASELSettingsFrame.maxVoltageEntry.get())
        minVoltage = int(self.HASELSettingsFrame.minVoltageEntry.get())
...
class HASELSettings(tk.LabelFrame):
    ...
    def create_widgets(self):
        ...
        self.physicalChannelEntry.insert(0, "HASEL_1")
